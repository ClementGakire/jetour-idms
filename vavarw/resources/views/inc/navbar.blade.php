          ...
          <div class="row">
            ...
            <div class="col-xl-2 col-lg-3 col-md-4 sidebar fixed-top" style="overflow-y: scroll; padding-right: 15px;">
              ...
              <ul class="navbar-nav flex-column mt-4">
                ...
                <li class="nav-item {{ Request::segment(1) === 'contracts' ? 'current' : null }}"><a href="/contracts" class="nav-link text-white p-3 mb-1 sidebar-link"><i class="fas fa-file-contract text-light fa-lg mr-3"></i>Contracts</a></li>
